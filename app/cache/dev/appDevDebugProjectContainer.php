...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '8889', 'dbname' => 'delcarmen', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_21979b859ec6b14886a203992fe4cdb986626652c4673aa4642f3207105dfe02');
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('comyasejuega@gmail.com');
        $a->setPassword('martinyagus');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('06fb3b6b55e8ed794c3c89ede3ed48ac');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'secret' => '06fb3b6b55e8ed794c3c89ede3ed48ac',
            ...
            'kernel.secret' => '06fb3b6b55e8ed794c3c89ede3ed48ac',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'comyasejuega@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'martinyagus',
